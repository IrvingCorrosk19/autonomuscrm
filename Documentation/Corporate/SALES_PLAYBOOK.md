...
Pipeline, forecast, calificación y cierre
...
**Comando:** acción **Calificar** en la ficha del lead → `lead.Qualify()`
...
| > **ADVERTENCIA** Access Denied en `/Users` | Rol Sales sin permiso admin | Escalar a Manager |
...
*Documento basado en: `Deal.cs`, `Lead.cs`, acción **Calificar** en la ficha del lead, `CloseDealCommand`, `RevenueOsService`, `CommercialSlaEngine`, `CustomerPlaybookService`, `RoleHomeRedirect.cs`.*
