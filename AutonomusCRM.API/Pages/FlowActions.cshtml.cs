...
public class FlowActionsModel : PageModel
{
        ...
        string priority = "High")
    {
        ...
        SetSuccess(_localizer["Flash_TaskCreated"].Value);
        ...
        string? rationale)
    {
        ...
        if (customer == null)
        {
            SetError(_localizer["Flash_CustomerNotFound"].Value);
            return Redirect(SafeReturn(returnUrl));
        }
        ...
        SetSuccess(result.Success ? _localizer["Flash_EmailSent"].Value : _localizer["Flash_EmailSent"].Value);
        return Redirect(SafeReturn(returnUrl));
    }
        ...
        string? rationale)
    {
        ...
        SetSuccess(_localizer["Flash_EscalatedTrust"].Value);
